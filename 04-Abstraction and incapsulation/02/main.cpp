...
// P.P.S. Прочитал подсказки. Вот уж действительно из пушки по воробьям. Переделывать не буду, class Address это решительно неинтересно
// Зачтите, плз, так, за перегрузку оператора <
